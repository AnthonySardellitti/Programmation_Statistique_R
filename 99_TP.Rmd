...
e. Les autres variables qualitatives doivent être en `factor`. Si ce n'est pas le cas, construire une boucle qui les convertit en `factor` les unes après les autres.
